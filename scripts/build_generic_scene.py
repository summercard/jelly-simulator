...
s['版本说明']='v007：实际网格表面接触、骨骼与形态键、双向软体接触；球体兼容模式保留'
j._UPDATING=False
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/'Q弹果冻_通用软体交互_v007.blend'))
...
preview=ROOT/'previews_v007';preview.mkdir(exist_ok=True)
...
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/'Q弹果冻_骨骼手掌演示_v007.blend'))
